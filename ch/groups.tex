...
\begin{proof}\(\)
    ...
    \begin{enumerate}[wide]
        ...
        \item[(c) \(\implies\) (a).] If \(\ker\phi = \{e\}\), then for any \(g,
        h \in G\), \(\phi(g) = \phi(h)\) implies that \(\phi(gh\inv) = e\), so
...
group is normal. In general, however, not all subgroups are normal. An example
of a commutative group where every subgroup is normal is the quaternion group
\(Q_8\).
