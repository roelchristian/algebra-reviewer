...
\Hom_{\catg{G}}(*, *)\) has an inverse \(f\inv\) such that
\[
...
\[
    \begin{tikzcd}
        G \arrow[r, "\phi"]                                                                  & H                                                        \\
        G\times G \arrow[d, "\pi_{G_1}"'] \arrow[u, "\pi_{G_1}"] \arrow[r, "\phi\times\phi"] & H\times H \arrow[u, "\pi_{H_1}"'] \arrow[d, "\pi_{H_2}"] \\
        G \arrow[r, "\phi"']                                                                 & H                                                       
        \end{tikzcd}
\]
...
\begin{proof}
    ...
    \[
        \begin{tikzcd}
            G \times G \arrow[d, "\mult_G"] \arrow[r, "\phi \times \phi"'] \arrow[rr, "(\phi \times \phi) \times (\psi \times \psi)", bend left] & H\times H \arrow[d, "\mult_H"] \arrow[r, "\psi \times \psi"'] & K\times K \arrow[d, "\mult_K"] \\
    ...
    rectangle must also commute. More explicitly, for all \(a, b \in G\),
    \begin{align*}
