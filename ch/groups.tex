...
\begin{example}[Free groups and presentations]
    ...
    \(\presentation{X}{r_1, r_2, \ldots, r_n = e}\).
    
    By choosing the set \(X\) as we have above, we guarantee that every group
    admits a presentation \(\presentation{X}{\mathcal{R}}\). In particular,
