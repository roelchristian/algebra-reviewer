...
\begin{definition}
    The order of a group \(G\) is the cardinality of the set \(G\), denoted by
    \(\order{G}\).
\end{definition}
...
\begin{proof}
    ...
    rectangle must also commute. By the universal property for products, there must exist a unique function
    \[
    ...
    \]
    the universal property for products again tells us that the diagram below commutes:
    \[
        \begin{tikzcd}
            ...
            \end{tikzcd}
    \]
    By the uniqueness of \((\psi \circ \phi) \times (\psi \circ \phi)\) we must then have
    \[
